...
def move_rocket(event):
    ...
    if event.keysym == "Left" and rocket_x > 20 and flag_input :
        ...
        temp_x = missile_vel_x*math.cos(2*math.pi * 15 / 360) - math.sin(2*math.pi * 15 / 360)*missile_vel_y
        temp_y = missile_vel_x*math.sin(2*math.pi * 15 / 360) + math.cos(2*math.pi * 15 / 360)*missile_vel_y
        missile_vel_x = temp_x
        missile_vel_y = temp_y
